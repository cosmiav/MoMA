        ...
        <div class="row pt-3 justify-content-between">
          ...
          <div class="col-md-5 align-self-center order-md-1">
            ...
            <h4>
              ...
              {{ formatDateMonth(exhibition.end_date) }}
            </h4>
          ...
          <div class="col-md-3 order-md-1">
            <div class="row">
              <div class="col-12">
                ...
                <p style="text-transform: capitalize">
                  {{ formatDateMonth(exhibition.start_date) }} -
                  {{ formatDateMonth(exhibition.end_date) }} <br />
                  {{ exhibition.status }}
                </p>
              </div>
...
export default {
  setup() {
    ...
    const { exhibition: exhibitions, formatDateMonth, getImage } = useDB();
    const exhibition = ref(null);

    const fetchExhibition = (exhibitionId) => {
      const foundExhibition = exhibitions.value.find(
        (e) => e.id.toString() === exhibitionId.toString()
      );
